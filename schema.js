...
module.exports = [
  ...
  {
    query: `CREATE INDEX IF NOT EXISTS ON "Discussions" ("tenantAlias")`
  },
  {
    query: `CREATE INDEX IF NOT EXISTS ON "Folders" ("tenantAlias")`
  },
  {
    query: `CREATE INDEX IF NOT EXISTS ON "Content" ("tenantAlias")`
  },
  {
